        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ flex: 1 }}>
                    ...
                    >Family</h4>
                    <p style={{ fontSize: '16px', color: '#333' }}>
                        <strong>บิดาชื่อ:</strong> นายอนุกุล นาข้าวต้ม อายุ 52 ปี  อาชีพ: เจ้าหน้าที่รักษาความปลอดภัยที่ธนาคารกรุงเทพ สาขาปทุมธานี<br />
                        <strong>มารดาชื่อ:</strong> นางวัชรา สงเคราะห์ธรรม อายุ 48 ปี  อาชีพ: พนักงานเย็บกระเป๋า ที่บริษัทบลูไล้ท์อุตสาหกรรมจำกัด
                    </p>
                </div>
            </div>
